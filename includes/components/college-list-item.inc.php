<li class="p-3 course__list__card rounded-3">
    <div class="row gx-4 gy-3 gy-lg-0">
        <div class="col-md-4 d-flex">
            <a href="college-details.php" class="d-flex w-100 h-100">
                <img 
                    src="<?php echo $image; ?>" 
                    alt="Course Image"
                    ...
                    <div class="col-lg-8">
                        ...
                        <ul class="ps-0 mb-0 row g-2 row-cols-1 row-cols-sm-2 info__list">
                            <li class="d-flex align-items-center gap-2">
                                ...
                                <span>Country:</span>
                                <span class="text-dark">india</span>
                            </li>
                            <li class="d-flex align-items-center gap-2">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                ...
                                <span class="text-dark">Private</span>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-4">
                        <div class="row g-2 row-cols-2 row-cols-sm-2 row-cols-lg-1 action__btns"> 
                            <div> 
                                <a href="college-details.php" class="btn btn-dark w-100 fw-medium">Learn More</a>
                            </div>
                            <div> 
                                <a href="#" class="btn btn-primary w-100 fw-medium first__btn">Download Broucher</a> 
                            </div>
                            <div>  
                                <a href="#" class="btn btn-primary w-100 fw-medium second__btn">View More</a>
                            </div>
                            <div>  
                                <a href="#" class="btn btn-primary w-100 fw-medium">View More</a>
                            </div> 
                        </div>
                    </div>
                </div>
